...
For this analysis, we will use the **usmap** package for making maps of invasive plant distributions. Remove the hashtag in front of `install.packages()` below to install it, and then load it using `library()`: 
